"""
Django settings for bcib_itba project.
...
LOGIN_URL = 'bcib-sprint7\bcib_itba\login\templates\login\login.html'

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/4.2/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-4rv7_qr0#jw7fda@zykb-i_rl%t&+34d=!))ibqrw&bu(yqaes'
...
WSGI_APPLICATION = 'bcib_itba.wsgi.application'
